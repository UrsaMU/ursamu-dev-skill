...
// import type { SessionEvent } from "jsr:@ursamu/mush"; // needed for event handler types
// import { gameHooks } from "jsr:@ursamu/mush";          // uncomment to use event hooks
${routeValueImport}import { registerHelpDir } from "jsr:@ursamu/help";
...
export function commandsTemplate(name) {
  return `import { addCmd } from "jsr:@ursamu/mush";
...
// IDBObj mirrors the engine world-object shape from @ursamu/mush.
type IDBObj = {
  id: string;
  name?: string;
  flags: Set<string>;
